...
import excel "C:\Users\wb344850\WBG\William Hutchins Seitz - 01.data\test_data\sms.xlsx", sheet("Sheet1") firstrow

//Do some data cleaning
drop toa sc_toa read status	locked type	subject backup_date	protocol date type contact_name service_center backup_set 
...
//Find and clean duplicated texts
	...
	// DUNSTAN: if this assertion fails, my understanding is we drop the duplicates
	//assert dupid == 0 This isnt necessary
	drop if dupid == 1
	drop dupid
...
//SAVE SMS OBSERVED FOR COMPARISON with python processing
export delimited using "C:\Users\wb344850\WBG\William Hutchins Seitz - 01.data\test_data\sms_observed.csv", replace

//Survival/Event Stata
	tsset device_id datetime
	sort device_id alive datetime
	//Dunstan: What does this compute?-time elapsed between two 
	//is it cumulative? if its not 
...
//2 different variables: one for duration of power on, another for time off
	...
	//Dunstan: These labels doesnt seem correct unless I dont understand 
...
//DUNSTAN: stopped here as I dont have any data on boxes
//Open list of boxes
	import excel "C:\Users\wb344850\WBG\William Hutchins Seitz - 01.data\Distribution_Boxes@13.xlsx", firstrow clear
...
//Open sms data
	...
	*DUNSTAN: so whats the significance of this variable?
	*To 
	g delivered = 0
	*The date being used here is neither datetime_received or datesent
...
**************************************
cd "$root\"
use "$root\Clean_Full_Elect_L2T@3.dta", clear
