...
//Set file location
	*global path "C:\Users\wb255520\Box Sync\Listening2Tajikistan\01.Eletricity_monitoring\"					/* JPA 	*/
	global path "C:\Users\WB454594\OneDrive - WBG\Tajikistan\Listening2Tajikistan\01.Eletricity_monitoring\"		/* WS	*/
	
	*global path "C:\Users\WB472222\Box Sync\Listening2Tajikistan\01.Eletricity_monitoring\"		/* OKI	*/
	*global root "$path\01.data"

//Open with import excel: dunstan
	import excel "C:\Users\wb344850\Google-Drive\worldbank\smart-survey-boxes\data\raw-sms-backup\sms-01-24-2018_verification.xlsx", sheet("Sheet1") firstrow
...
//dunstan: since I'm using date_sent, I dont have to do this
...
//Create temporary file (to merge date of start)
	tempfile fullsms
	save `fullsms'
	save "C:\Users\wb344850\Google-Drive\worldbank\smart-survey-boxes\data\fullsms", replace
	export delimited using "C:\Users\wb344850\Google-Drive\worldbank\smart-survey-boxes\data\fullsms.csv", replace
	
	
//Open list of boxes
	*import excel "$root\Distribution_Boxes@`j'.xlsx", firstrow clear
	import excel "C:\Users\wb344850\Google-Drive\worldbank\smart-survey-boxes\data\Distribution_Boxes@12.xlsx", sheet("Sheet1") firstrow clear
	clonevar PSU_ID = ClusterId
	
//Merge coordinates
	*merge m:1 PSU_ID using "$root\PSU_Coordinates"
	merge m:1 PSU_ID using "C:\Users\wb344850\Google-Drive\worldbank\smart-survey-boxes\data\PSU_Coordinates"
	drop if _m==2
	drop _m
...
//Find and clean duplicated BoxIDs
	...
	*save "$root\Boxes", replace
	save "C:\Users\wb344850\Google-Drive\worldbank\smart-survey-boxes\data\Boxes", replace
	...
	*export delimited using "$root\BoxDetails.csv", replace
	export delimited using "C:\Users\wb344850\Google-Drive\worldbank\smart-survey-boxes\data\BoxDetails.csv", replace
	...
	*export delimited using "$root\Clean_Full_Elect_L2T@`vers'.xlsx", firstrow(variables) sh(Boxes)  sheetrep
	...
	*export delimited using "$root\Boxes.csv", replace
	export delimited using "C:\Users\wb344850\Google-Drive\worldbank\smart-survey-boxes\data\Boxes.csv", replace
...
//Save date start
	tempfile datestart
	*save `datestart'
	save "C:\Users\wb344850\Google-Drive\worldbank\smart-survey-boxes\data\datestart", replace
	
//Open sms data
	*use `fullsms', clear
	use "C:\Users\wb344850\Google-Drive\worldbank\smart-survey-boxes\data\fullsms", clear
	clonevar BoxID = device_id 
	merge m:1 BoxID using "C:\Users\wb344850\Google-Drive\worldbank\smart-survey-boxes\data\datestart"
...
//Create "full" dataset
	*save "$root\Clean_Full_Elect_L2T@`vers'.dta", replace
	save "C:\Users\wb344850\Google-Drive\worldbank\smart-survey-boxes\data\Clean_Full_Elect_L2T@`vers'.dta", replace
	...
	*export delimited using "$root\Data.csv", replace
	export delimited using "C:\Users\wb344850\Google-Drive\worldbank\smart-survey-boxes\data\Data.csv", replace
...
use "C:\Users\wb344850\Google-Drive\worldbank\smart-survey-boxes\data\Clean_Full_Elect_L2T@3"
...
*save check, replace
save "C:\Users\wb344850\Google-Drive\worldbank\smart-survey-boxes\data\check", replace
...
preserve
	...
	sort BoxID date_powerfailure date_powerfailure_hour 
	*save tmp, replace
	save "C:\Users\wb344850\Google-Drive\worldbank\smart-survey-boxes\data\tmp", replace
...
merge BoxID date_powerfailure  using "C:\Users\wb344850\Google-Drive\worldbank\smart-survey-boxes\data\check"
...
*save "$root\powerout_impfile", replace
...
export delimited using "C:\Users\wb344850\Google-Drive\worldbank\smart-survey-boxes\data\powerout.csv", replace
