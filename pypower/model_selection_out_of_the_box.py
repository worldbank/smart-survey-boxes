...
def print_experiment_details(df, target_var):
    print('5. Data-size===> observed events, {:,} events !!'.format(df.shape[0]))
    print('6. Frequency distribution for target variable')
    print('[Downsampled majority class, so accuracy measure can make more sense]')
